...
# ###### ----------- MAB strategies ---------------------------------------####
    ...
    def online_trial(self, bandit=None, payout=None, strategy='eps_greedy', step_size=None
                     parameters=None):
        '''
    ...
    def multiple_trials(self, bandits=None, payouts=None, method = 'hard', strategy='eps_greedy',
                     parameters=None):
        '''
